                ...
                <div class="dashboard-content-container" data-simplebar>
                    <div class="dashboard-content-inner" >
                        ...
                        <form action="createBoard" method="post">
                                        ...
                                        <div class="content with-padding padding-bottom-10">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="submit-field">
                                                        <h5>Board Name</h5>
                                                        <input type="text" name="boardName" class="with-border" placeholder="e.g. build a website" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="submit-field">
                                                    ...
                                                    <div class="radio">
                                                        <input id="bg-1" name="backgroundImage" type="radio" value="images/backgroundImage1.jpg" checked>
                                                        <label for="bg-1"><img src="images/backgroundImage1.jpg" alt="Background 1" width="100"></label>
                                                    </div>

                                                    <div class="radio">
                                                        <input id="bg-2" name="backgroundImage" type="radio" value="images/backgroundImage2.jpg">
                                                        <label for="bg-2"><img src="images/backgroundImage2.jpg" alt="Background 2" width="100"></label>
                                                    </div>

                                                    <div class="radio">
                                                        <input id="bg-3" name="backgroundImage" type="radio" value="images/backgroundImage3.jpg">
                                                        <label for="bg-3"><img src="images/backgroundImage3.jpg" alt="Background 3" width="100"></label>
                                                    </div>

                                                    <div class="radio">
                                                        <input id="bg-4" name="backgroundImage" type="radio" value="images/backgroundImage4.jpg">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="submit-field">
                                                    ...
                                                    <textarea cols="30" rows="5" class="with-border" name="describe" required></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xl-12">
                                <button type="submit" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Create a Board</button>
                            </div>
                        </form>
                        <!-- Snackbar -->
                        <div id="snackbar"></div>
